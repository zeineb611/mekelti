...
<?php require_once 'header_main1.php'; ?>
...
<body>
  ...
  <div class="owl-carousel owl-single px-0">
    <div class="site-blocks-cover overlay" style="background-image: url('images/hero1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mx-auto align-self-center">
            <div class="site-block-cover-content text-center">
              <h1 class="mb-0"><strong class="text-primary">Makelti</strong> Opens 24 Hours</h1>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('images/hero2.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mx-auto align-self-center">
            <div class="site-block-cover-content text-center">
    ...
    <div class="container">
      <div class="row">
        <div class="title-section text-center col-12">
          <h2>Makelti <strong class="text-primary">Products</strong></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 block-3 products-wrap">
          <div class="nonloop-block-3 owl-carousel">
            ...
            <div class="text-center item mb-4 item-v2">
              ...
              <a href="shop-single.html"> <img src="images/pizza.png" alt="Image"></a>
              <h3 class="text-dark"><a href="shop-single.html">Pizza Margherita</a></h3>
              <p class="price">11.00TND</p>
            </div>

            <div class="text-center item mb-4 item-v2">
              <a href="shop-single.html"> <img src="images/couscous.png" alt="Image"></a>
              <h3 class="text-dark"><a href="shop-single.html">Couscous</a></h3>
              <p class="price">20.00TND</p>
            </div>

            <div class="text-center item mb-4 item-v2">
              <span class="onsale">Sale</span>
              <a href="shop-single.html"> <img src="images/lasania.png" alt="Image"></a>
              <h3 class="text-dark"><a href="shop-single.html">Lasagnes</a></h3>
              <p class="price">14.00</p>
            </div>

            <div class="text-center item mb-4 item-v2">
              <a href="shop-single.html"> <img src="images/brik.png" alt="Image"></a>
              <h3 class="text-dark"><a href="shop-single.html">Brik</a></h3>
              <p class="price">3.00TND</p>
            </div>
