<?php include "../../Controller/ajouterlieu.php";
...
<section id="the-menu">
            <div class="section-inner">
                ...
                <?PHP
               // require_once "../../controller/ajouterevent.php";
            foreach ($listelieu as $row) {
                
              //  foreach ($listeevent as $row) {
              //  if($row['nome']==$row['nomevent'])
               // {
            ?>
                    <div class="row">
                        <div class="col-md-6 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                            <h2 class="mb50"><span class="heading-font text-uppercase">Lieu</span></h2>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="images/<?PHP echo $row['imagelieu']; ?>" class="img-responsive">
                                    </div>
                                    
                                    <div class="col-xs-9">
                                       
                                    <h3><?PHP echo $row['nomlieu']; ?>         </h3>
                                        <h5><?PHP echo $row['descriptionlieu']; ?>         </h5>
                                        <h5>De  <?PHP echo $row['datelieu']; ?>        </h5>
                                        <h5>à   <?PHP echo $row['datelieuf']; ?>         </h5>
                                    </div>
