                    ...
                    <div>
                        <form method="post" action="">
                            ...
                            <div class="form-group">
                                <label for="nomlieu">Taper le nom de lieu</label>
                                <input type="text" class="form-control" name="nomlieu" id="nomlieu" placeholder="Entrer le nom de lieu">
                            </div>
       
                            <div class="form-group">
                              <label for="imagelieu">Ajouter Image du lieu</label>
                                <input type="file" class="form-control-file" name="imagelieu">
                            </div>

                            <div class="form-group">
                                <label for="descriptionlieu">Ajouter la description du lieu</label>
                                <input type="text" class="form-control" name="descriptionlieu" id="descriptionlieu" placeholder="Entrer la description">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="nome">Ajouter Le nom de levennement</label>
                                <input type="text" class="form-control" name="nome" id="nome" placeholder="Entrer le nom de levennement">
                            </div>
