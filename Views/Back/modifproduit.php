...
<div id="wrapper">
  ...
  <?php
      ...
      <tr>
				...
				<td><?=$produit["qty"]?></td>
                <td><?=$produit["idcat"]?></td>
                <td><img src="../Front/images/<?php echo $produit["image"];?>" width="50" height="50" alt="" /></td>
                <td>
             ...
             <td><button type="submit" class="btn btn-warning my-1"><a href="modifproduit.php?id=<?php echo $produit["id"];?>"> Modifier </a></button></td>
			</tr>
            <?php }?>
  </tbody>
</table>
