...
if (
    ...
    if (
        ...
        if( $promotionC->verifierPromotion($_POST["name"]) == 0 )
        {
        ...
        {
            echo "<script> alert('Promotion Already Exist') </script>";
        }
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="Nom du promotion" required>
                        </div>
                        <div class="form-group">
                            <label for="pourcentage">Pourcentage</label>
                            <input type="number" class="form-control" name="pourcentage" id="pourcentage" placeholder="pourcentage du promotion" required>
                        </div>
