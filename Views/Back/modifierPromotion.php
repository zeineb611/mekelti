...
if (
    ...
    if (
        ...
        header('refresh:2;url=afficherPromotions.php');
    } else
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="<?PHP echo $promotion['name']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="pourcentage">Entrez le pourcentage</label>
                            <input type="number" class="form-control" name="pourcentage" id="pourcentage" value="<?PHP echo $promotion['pourcentage']; ?>" required>
                        </div>
