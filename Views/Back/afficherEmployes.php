                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1 align='center'>
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th>Photo</th>
                                    <th colspan="2">
                                        <form method="get" action="modifierEmploye.php" >
                                            <input type="text" class="float-left" name="recherche" placeholder=" Taper l'ID de l'employé">
                            ...
                            <tr class="table-primary">
                                ...
                                <td>
                                    <form method="POST" action="../../Controller/supprimerEmploye.php">
