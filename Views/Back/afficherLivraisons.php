                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?PHP
                            ...
                            //$listeLivraisons = $livraisonController->pagination($page, $perpage);
                            //$totalP = $livraisonController->calcTotalRows($perpage);
//$listeLivraison = $livraisonController
                            ...
                            if(isset($_GET['recherche']))
                            {
                                ...
                                $listeLivraisons=$livraisonController->recherche($search_value);
                            }

                            //trie
                            if(isset($_GET['trie']))
                            {
                                $listeLivraisons = $livraisonController->trieCroissant($page, $perpage);
                            }
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tableau des livraisons</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="2">
                                                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="afficherClients.php">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control bg-light border-0 small" placeholder="Chercher livraison"
                                                    ...
                                                    <th>
                                                        <form method="get" action="getLivraisons.php">
            ...
            <input type="hidden" value="<?PHP echo $row['id_livraison']; ?>" name="id_livraison">
                                                    ...
                                                    <td>
                                                        <a  class="btn btn-primary" href="modifierLivraison.php?id_livraison=<?PHP echo $row['id_livraison']; ?>"> Modifier </a>
                                                    </td>
                                                </tr>
